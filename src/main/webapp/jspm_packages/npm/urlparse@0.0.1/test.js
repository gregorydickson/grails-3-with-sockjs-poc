...
module.exports = {
  "parse": function(test) {
    function parseTest(url, object) {
      ...
      Object.keys(parsedUrl).forEach(function(k) {
        if (typeof parsedUrl[k] !== 'string')
          delete parsedUrl[k];
      });
      test.deepEqual(parsedUrl, object);
    }
    parseTest("http://apps.mozillalabs.com", {
    ...
    parseTest("file:///Users/lth/dev/urlmatch/somefile.html", {
      "file": "somefile.html",
    ...
    parseTest("https://secu.re:443/foo/../bar/x.html", {
      "file": "x.html",
      "directory": "/foo/../bar/",
      "path": "/foo/../bar/x.html",
    ...
    parseTest("http://user@host.com:76543", {
      "port": "76543",
      "host": "host.com",
      "user": "user",
      "userInfo": "user",
    ...
    parseTest("http://user:pass@host.com:81?query#anchor", {
      "anchor": "anchor",
      "query": "query",
  ...
  "normalize": function(test) {
    function normalize(s) {
      return urlparse(s).validate().normalize().toString();
    }
    ;
